...
function Admin() {
  ...
  useEffect(() => {
    fetch('https://ecommrcebakend-1.onrender.com/cat/getall')
      .then((res) => res.json())
      .then((data) => setCategories(data.data))
      .catch((err) => console.error(err));

    fetch('https://ecommrcebakend-1.onrender.com/sub/allget')
      .then((res) => res.json())
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://ecommrcebakend-1.onrender.com/product/add", {
      method: "POST",
      headers: {
